<script>
  ...
  function handleAddCategory() {
      ...
      window.location.href = `/communities/${communityNameId}/Management/CM_Events/CM_EventDetail/${eventId}/CM_EventCategory/CM_CreateEventCategory`;
  }
  ...
  {:else}
      ...
      <div>
          {#each categories as category}
              <DropdownCard id={category.id} title={category.title} quota={category.quota} terms="Terms and Conditions" price={category.price}>
